...
import sty from "./PlasmicVariety414Px.module.css"; // plasmic-import: PTpXkavzH-h9r/css

export type PlasmicVariety414Px__VariantMembers = {};
export type PlasmicVariety414Px__VariantsArgs = {};
type VariantPropType = keyof PlasmicVariety414Px__VariantsArgs;
export const PlasmicVariety414Px__VariantProps = new Array<VariantPropType>();

export type PlasmicVariety414Px__ArgsType = {};
type ArgPropType = keyof PlasmicVariety414Px__ArgsType;
export const PlasmicVariety414Px__ArgProps = new Array<ArgPropType>();

export type PlasmicVariety414Px__OverridesType = {
  div35?: p.Flex<"div">;
  a4?: p.Flex<"div">;
...
export interface DefaultVariety414PxProps {
  className?: string;
}
...
function PlasmicVariety414Px__RenderFunc(props: {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicVariety414Px__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicVariety414Px__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicVariety414Px__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicVariety414Px__ArgProps,
          internalVariantPropNames: PlasmicVariety414Px__VariantProps
        }),
      [props, nodeName]
    );
  ...
  if (nodeName === "div35") {
    func.displayName = "PlasmicVariety414Px";
  } else {
    func.displayName = `PlasmicVariety414Px.${nodeName}`;
  }
  return func;
}

export const PlasmicVariety414Px = Object.assign(
  // Top-level PlasmicVariety414Px renders the root element
  makeNodeComponent("div35"),
  {
    ...
    // Metadata about props expected for PlasmicVariety414Px
    internalVariantProps: PlasmicVariety414Px__VariantProps,
    internalArgProps: PlasmicVariety414Px__ArgProps
  }
);

export default PlasmicVariety414Px;
/* prettier-ignore-end */

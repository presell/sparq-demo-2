...
import sty from "./PlasmicReviewCard.module.css"; // plasmic-import: nUoaqN-SaUuh/css
  ...
  return (
    true ? (
      ...
      >
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__whNtu)}
          ...
          src={{
            src: "/plasmic/sparq_master_app_active_production/images/sidereview1Png.png",
            fullWidth: 119,
            fullHeight: 119,
        ...
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__uw2WO)}

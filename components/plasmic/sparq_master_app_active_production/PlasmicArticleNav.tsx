...
import sty from "./PlasmicArticleNav.module.css"; // plasmic-import: wMVlJStffjfS/css
  ...
  return (
    (
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__vm13Z)}>
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/sparq_master_app_active_production/images/logopng.png",
                fullWidth: 276,
                fullHeight: 46,
          ...
          <div className={classNames(projectcss.all, sty.column___3OllR)}>
            <div

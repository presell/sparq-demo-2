...
import Reviews from "../../Reviews"; // plasmic-import: IsuBJaFpBL0Q/component
...
import sty from "./PlasmicArticleIntro.module.css"; // plasmic-import: r22yJiNXgfNi/css
  ...
  return (
    ...
    >
      ...
      {(hasVariant(globalVariants, "screen", "desktopOnly") ? true : true) ? (
        ...
        >
          <div className={classNames(projectcss.all, sty.column___6UZh)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column___3ApYq)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
